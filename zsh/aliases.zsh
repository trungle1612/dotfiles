...
# Awesome_book
alias awe='cd workspace/code/awesome_book'

# amazon
alias amazon='ssh -i lexuantrung.pem ubuntu@ec2-54-164-183-107.compute-1.amazonaws.com'
alias ip='amazon: 54-164-183-107'

# cohota
alias cohota='cd cd workspace/code/cohota'
alias setting_toroto='git checkout setting Gemfile.lock'
# totoro
alias rtoto='bundle exec unicorn_rails -p 4000 -c config/development.unicorn.conf.rb'
# catbus
alias catbus='cd; cd workspace/code/cohota/new/catbus'
#hp
alias touchp='synclient TouchpadOff=1'
# rails
alias bs='bundle install'
alias rs='rails s'
alias rs1='rails s -p 3001'

# Mysql
alias msql='mysql -uroot -proot'
# Tmuxinator
